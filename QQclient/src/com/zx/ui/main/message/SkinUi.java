...
public class SkinUi extends JFrame implements MouseListener{
	...
	private JPanel getSkinPanel(){
		if(skinPanel == null){
			...
			for(int i=0;i<18;i++){
				final int j =i;
				ImageIcon icon = new ImageIcon(SkinUi.class.getResource("/com/xd/imgs/skin/ms/"+i+".jpg"));
				...
				label.addMouseListener(new MouseListener() {
					...
					public void mouseClicked(MouseEvent e) {
						if(e.getSource() == label){
							Image icon = new ImageIcon(SkinUi.class.getResource("/com/xd/imgs/skin/ms/"+j+".jpg")).getImage();
						MessageUi.panel.setBackgroundImage(icon);
						}
					}
					@Override
